...
const SelectCoursePeriodForGradebook: React.FC<SelectCoursePeriodForGradebookProps> = ({ 
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg shadow">
      <label htmlFor="course_period_selector_gradebook" className="flex items-center text-sm font-medium text-gray-700 mb-1">
        Select Class to View Gradebook
        <HelpTooltip helpKey="gradebook_selectClass" position="right" className="ml-1.5" />
      </label>
      <select
        id="course_period_selector_gradebook"
...
export default SelectCoursePeriodForGradebook;
